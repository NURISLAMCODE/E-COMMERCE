...
const featuredTitles1 = [womenDress, grilsDress, girlsWatches];
...
const profileButtonList = [orders, wishlist, massages];
const profilButtonIcon = [icOrder, icOrders, icMessages];
